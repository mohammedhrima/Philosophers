...
void print_state(t_philo *philo, char *str)
{
    ...
    if (ft_strcmp(str, "has taken fork") == 0)
        printf(" %d %d", philo->index, philo->next->index);
    printf("\n");
...
int main(void)
{
    ...
    t_micro_sec time_to_sleep = THOUSAND * 100;
    t_micro_sec time_to_eat = THOUSAND * 100;
    t_micro_sec time_to_die = THOUSAND * 400;
